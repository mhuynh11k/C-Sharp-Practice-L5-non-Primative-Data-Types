...
//Hint: You can use the Console.WriteLine() method to output the result.
// result.IndexOf('o');
// Console.WriteLine($"The index of the character 'o' is: {result.IndexOf('o')}");
//Part 5
...
//Hint: You can use the Console.WriteLine() method to output the result.
// int _startIndex = 4;
// int _lastIndex = result.IndexOf('o', _startIndex);
// Console.WriteLine($"The index of the character 'o' starting from index {_startIndex} is: {_lastIndex}");
//Part 6
//Write a program to count the occurrences of a specific character in a string.
//Hint: You can use the Count() method to count the occurrences of a specific character in a string.
//Hint: You can use the Console.WriteLine() method to output the result.
// int _Count = result.Count(c => c == 'o');
// Console.WriteLine($"The number of occurrences of the character 'o' is: {_Count}");
...
//Hint: You can use the Console.WriteLine() method to output the result.
// string replacedResult = result.Replace('o', 'x');
// Console.WriteLine($"The string after replacing 'o' with 'x' is: {replacedResult}");
...
//Hint: You can use the Console.WriteLine() method to output the result.
// string removedResult = result.Remove(result.IndexOf('o'), 1);
// Console.WriteLine($"The string after removing the first occurrence of 'o' is: {removedResult}");
...
// char charToReplace = char.Parse(Console.ReadLine());

// Console.Write("Enter the replacement character: ");
// char newChar = char.Parse(Console.ReadLine());

// string replacedAllResult = inputChar.Replace(charToReplace, newChar);
// Console.WriteLine($"The string after replacing all occurrences of '{charToReplace}' with '{newChar}' is: {replacedAllResult}");
//Part 10
...
// string subText = sampleText.Substring(6, 5); // starts at index 6 and takes 5 characters
...
//Hint: You can use the Console.WriteLine() method to output the result.
// string remainingText = sampleText.Substring(6); // starts at index 6 and continues to the end
// Console.WriteLine($"Substring from index 6 to end: {remainingText}");
...
Console.WriteLine($"Trimmed string: '{trimmedText}'");
//Part 13 
