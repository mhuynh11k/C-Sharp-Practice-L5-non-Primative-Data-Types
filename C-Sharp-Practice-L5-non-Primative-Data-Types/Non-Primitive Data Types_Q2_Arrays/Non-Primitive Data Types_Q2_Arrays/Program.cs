...
string[] names = new string[5] { "John", "Jane", "Jack", "Jill", "James" };
...
// Console.WriteLine($"The name in the 3rd position is: {names[2]}");
...
names[2] = newName;
Console.WriteLine("After replacing the name in the 3rd position:");
foreach (string name in names)
{
    Console.WriteLine(name);
}
...
// {
//     Console.WriteLine($"{nameToCheck} exists in the array.");
// }
// else
// {
//     Console.WriteLine($"{nameToCheck} does not exist in the array.");
// }
//---------------------------------------------------------------------
...
string nameToFind = "Jessica";
int index = Array.IndexOf(names, nameToFind);
if (index != -1)
{
...
{
    Console.WriteLine($"{nameToFind} is not found in the array.");
}
